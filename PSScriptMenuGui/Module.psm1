if ($PSEdition -eq 'Core') {
    if (-not $IsWindows) {
        throw 'Этот модуль работает только в Windows'
    }
    if ($PSVersionTable.PSVersion.Major -eq 6) {
        throw 'Этот модуль несовместим с PowerShell Core 6'
    }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU//pFixt5aWyBfx54Zvb3WsWh
# YwygggzVMIIGTjCCBDagAwIBAgITTwAAB6r7HLyYxe8w1QABAAAHqjANBgkqhkiG
...
# BDEWBBSCDnA054r1UpHG65XKuRXgKMv/kDANBgkqhkiG9w0BAQEFAASCAQCVYkvS
# /gUlG7hNPTniVIZYErFtjzU3kDLxgOdB9T+EVQef665nhfZALgsEWuIwZuA6StXa
# ErSsAhBrGc2DHPWCxJ9mbm+BEfbb9WwG6/7WHgb4GqH7HOdXaWrIDaJYqfgTBPYM
# OJisWy7mYvwmQRDNdfZUZCPUWDysUOJqMU18c2hrPsK26ozkg5hqT+7Z5hzzTf/h
# l1nQ4fJ32leZ/C4Ix7X3PtfRu96/9ro10EGlKr41LqOA+LGgEg2+KcA5NLt/WGvf
# HBGU3NW+FcE1rvq1Ip0t4R4l9hQdkM4pMhiY1sx9J8e7gbEo7rE2ol8lSyK/9+aP
# yACcv1oOeNl6DYJP
